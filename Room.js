$(function(){
    ...
    var d = 2;
    var zoomFactor = 0.6; // Adjust this value to control the zoom level

    // Calculate the new frustum values
    var left = - d * aspect * zoomFactor;
    var right = d * aspect * zoomFactor;
    var top = d * zoomFactor;
    var bottom = - d * zoomFactor;
